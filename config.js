...
module.exports = {
  token: '', // MTQxMDY1MTcwMTA4OTkzMTQzOQ.GnBG4D.VXTRTBiLEAiAvp3Z7VX4I_DrTqdMRy2Tp3sgYg
  allowedChannelId: '', // 1410643776191463464

  // اوقات التجميد لكل امر
  cooldowns: {
    راتب: ms('30s'), // زيادة المهلة للحصول على الراتب
    حظ: ms('35s'), // زيادة المهلة لأمر الحظ
    استثمار: ms('45s'), // زيادة المهلة للاستثمار
    تداول: ms('45s'), // زيادة المهلة للتداول
    قرض: ms('10h'), // زيادة المهلة لأخذ قرض جديد
    توب: ms('5s'), // زيادة المهلة لقائمة الأغنياء
    نرد: ms('30s'), // زيادة المهلة للعبة النرد
    قمار: ms('30s'), // زيادة المهلة لأمر القمار
    نهب: ms('3m'), // زيادة المهلة لأمر النهب
    حماية: ms('1h'), // زيادة المهلة لتفعيل الحماية
    يومي: ms('1d'), // زيادة المهلة للأمر اليومي
  ...
  transferTaxRate: 0.10, // زيادة نسبة الضريبة على التحويلات المالية
  ...
  jobTitles: [
    ...
    { name: 'رقاصة', cost: 3000, salary: 800 },
